<template>
    <div style="margin-top:18%, padding-bottom:50px;">
        <div v-if="is_registered===''">
            ...
            Enter your Aadhar number:<input v-model="recipient_aadhar" type="password"/><br><br>
            Enter Secret Phrase:<input v-model="recipient_secret_phrase" type="password"/><br><br>
...
export default {
  ...
  data () {
    return {
      ...
      hash_contract: null,
      recipient_secret_phrase: null,
      recipient_aadhar: null
    }
  },
  filters: {
    details (user) {
  ...
  methods: {
    registerRecipient: function () {
      let data = JSON.stringify({'recipient_name': this.recipient_name, 'recipient_email': this.recipient_email, 'recipient_phone': this.recipient_phone, 'recipient_aadhar': this.recipient_aadhar, 'recipient_secret_phrase': this.recipient_secret_phrase})
      console.log(data)
